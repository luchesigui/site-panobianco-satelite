            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-body text-secondary">Certificações reconhecidas nacionalmente</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-primary-500 mt-0.5" />
                  <span className="text-body text-secondary">Experiência em diversas modalidades</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-primary-500 mt-0.5" />
                  <span className="text-body text-secondary">Especialização em diferentes objetivos</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-primary-500 mt-0.5" />
                  <span className="text-body text-secondary">Atualização constante em novas técnicas</span>
                </li>
              </ul>
            </div>
            <div className="bg-primary rounded-lg p-8">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-body text-secondary">Emagrecimento e queima de gordura</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary-500 rounded-full"></div>
                  <span className="text-body text-secondary">Ganho de massa muscular</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary-500 rounded-full"></div>
                  <span className="text-body text-secondary">Performance esportiva</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary-500 rounded-full"></div>
                  <span className="text-body text-secondary">Reabilitação e fisioterapia</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary-500 rounded-full"></div>
                  <span className="text-body text-secondary">Condicionamento físico geral</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary-500 rounded-full"></div>
                  <span className="text-body text-secondary">Treinamento funcional</span>
                </div>
              </div>
            </div>
          </div>
