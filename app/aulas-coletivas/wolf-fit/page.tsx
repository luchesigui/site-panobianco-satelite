            ...
            <div className="card">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-body text-secondary">Intensidade: Alta</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Users className="h-5 w-5 text-orange-500" />
                  <span className="text-body text-secondary">Adaptável a todos os níveis</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Target className="h-5 w-5 text-orange-500" />
                  <span className="text-body text-secondary">Foco: Funcional e cardio</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container-main">
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="card text-center">
                <h3 className="text-heading text-primary mb-3">Intermediários</h3>
                <p className="text-body text-secondary">
                  Intensidade moderada com desafios progressivos
                </p>
              </div>
              <div className="card text-center">
                <h3 className="text-heading text-primary mb-3">Avançados</h3>
                <p className="text-body text-secondary">
