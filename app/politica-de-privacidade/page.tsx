              ...
              <div className="space-y-12">
                ...
                <div>
                  <div className="flex items-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-neutral-text-primary">1. Coleta de Dados Pessoais</h2>
                  </div>
                ...
                <div>
                  <div className="flex items-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-neutral-text-primary">2. Uso dos Dados Pessoais</h2>
                  </div>
                  <p className="text-body text-neutral-text-secondary mb-4">
                ...
                <div>
                  <div className="flex items-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-neutral-text-primary">3. Compartilhamento de Dados Pessoais</h2>
                  </div>
                  <p className="text-body text-neutral-text-secondary mb-4">
                ...
                <div>
                  <div className="flex items-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-neutral-text-primary">4. Cookies e Tecnologias Semelhantes</h2>
                  </div>
                ...
                <div>
                  <div className="flex items-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-neutral-text-primary">5. Segurança dos Dados</h2>
                  </div>
                  <p className="text-body text-neutral-text-secondary">
                ...
                <div>
                  <div className="flex items-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-neutral-text-primary">6. Seus Direitos</h2>
                  </div>
                  <p className="text-body text-neutral-text-secondary mb-4">
                ...
                {/* Alterações */}
                <div>
                  <h2 className="text-2xl font-bold text-neutral-text-primary mb-4">7. Alterações a Esta Política de Privacidade</h2>
                  <p className="text-body text-neutral-text-secondary">
                ...
                <div className="bg-neutral-surface rounded-lg p-8">
                  <h2 className="text-2xl font-bold text-neutral-text-primary mb-6">8. Contato</h2>
