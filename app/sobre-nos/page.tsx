          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="card">
              <div className="flex items-center justify-center w-16 h-16 bg-primary-500 rounded-full mb-6 mx-auto">
                <Heart className="h-8 w-8 text-neutral-text-primary" />
              </div>
              <h3 className="text-heading text-neutral-text-primary text-center mb-4">
                Nossa Missão
              </h3>
              <p className="text-body text-neutral-text-secondary text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <div className="card text-center">
              <div className="flex items-center justify-center w-12 h-12 bg-primary-500 rounded-lg mb-4 mx-auto">
                <Award className="h-6 w-6 text-neutral-text-primary" />
              </div>
            ...
            <div className="card text-center">
              <div className="flex items-center justify-center w-12 h-12 bg-primary-500 rounded-lg mb-4 mx-auto">
                <Heart className="h-6 w-6 text-neutral-text-primary" />
              </div>
              <h3 className="text-heading text-neutral-text-primary mb-3">
                Paixão
              </h3>
            ...
            <div className="card text-center">
              <div className="flex items-center justify-center w-12 h-12 bg-primary-500 rounded-lg mb-4 mx-auto">
                <Target className="h-6 w-6 text-neutral-text-primary" />
              </div>
              <h3 className="text-heading text-neutral-text-primary mb-3">
                Integridade
              </h3>
        ...
        <div className="container-main">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card">
              ...
              <p className="text-body text-neutral-text-secondary">
                De musculação a aulas coletivas como Zumba, Spinning, Yoga, Pilates e muito mais, nossa grade de horários é diversificada para atender a todos os gostos e objetivos.
              </p>
            </div>
