              ...
              <div className="space-y-12">
                ...
                <div>
                  <div className="flex items-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-primary">2. Alterações nos Termos</h2>
                  </div>
                  <p className="text-body text-secondary">
                ...
                <div>
                  <div className="flex items-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-primary">3. Uso do Website</h2>
                  </div>
                ...
                <div>
                  <div className="flex items-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-primary">5. Links para Outros Websites</h2>
                  </div>
                  <p className="text-body text-secondary">
                ...
                <div>
                  <div className="flex items-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-primary">6. Isenção de Garantias</h2>
                  </div>
                  <p className="text-body text-secondary">
                ...
                <div>
                  <div className="flex items-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-primary">8. Indenização</h2>
                  </div>
                  <p className="text-body text-secondary mb-4">
                ...
                <div className="bg-secondary rounded-lg p-8">
                  <h2 className="text-2xl font-bold text-primary mb-6">10. Contato</h2>
