  ...
  return (
    <div className="bg-primary">
        ...
        <div className="container-main">
          <div className="text-center">
            <h1 className="text-4xl lg:text-6xl font-bold text-primary mb-6">
              <span className="text-primary-500">Treino Personalizado</span>
              <br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="https://wa.me/5512992192268?text=Olá! Eu vim do site e tenho interesse em um acompanhamento personalizado com um peronsal."
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card hover:border-primary-500 transition-colors">
              ...
              <p className="text-body text-secondary">
                Seja emagrecimento, ganho de massa muscular, melhora da
                performance esportiva, reabilitação ou condicionamento geral,
                seu treino será 100% focado no que você realmente busca.
              </p>
            </div>
            ...
            <div className="card hover:border-primary-500 transition-colors">
              ...
              <p className="text-body text-secondary">
                Um personal trainer experiente garante a execução correta de
                cada exercício, minimizando o risco de lesões e maximizando a
            ...
            <div className="card hover:border-primary-500 transition-colors">
              ...
              <p className="text-body text-secondary">
                A presença de um profissional que te incentiva, te desafia e te
                mantém responsável é um poderoso fator motivacional para superar
                a preguiça e manter a disciplina.
              </p>
            </div>
            ...
            <div className="card hover:border-primary-500 transition-colors">
              ...
              <p className="text-body text-secondary">
                Seu personal trainer irá constantemente inovar seu treino,
                introduzindo novos exercícios, técnicas e equipamentos, evitando
                a monotonia.
              </p>
            </div>
            ...
            <div className="card hover:border-primary-500 transition-colors">
              ...
              <p className="text-body text-secondary">
                Com um plano de treino eficiente e focado, você aproveita ao
                máximo cada minuto na academia, alcançando mais resultados em
                menos tempo.
              </p>
            </div>
            ...
            <div className="card hover:border-primary-500 transition-colors">
              ...
              <p className="text-body text-secondary">
                Seu programa de treino será ajustado conforme sua evolução, suas
                necessidades e até mesmo seu humor no dia, garantindo que você
                esteja sempre no caminho certo.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-secondary">
        <div className="container-main">
          <div className="text-center mb-12">
            ...
            <p className="text-body text-secondary max-w-2xl mx-auto">
              Nossa equipe de personal trainers é composta por profissionais
              altamente qualificados, certificados e com vasta experiência em
              diversas áreas do condicionamento físico.
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="container-main">
          <div className="text-center mb-12">
            <h2 className="text-display text-primary mb-4">Como Funciona?</h2>
            <p className="text-body text-secondary max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-body text-secondary">
                Seu personal trainer realizará uma avaliação completa para
                entender seu histórico de saúde, nível de condicionamento
                físico, objetivos e preferências.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-body text-secondary">
                Com base na avaliação, será desenvolvido um programa de treino
                exclusivo, detalhando os exercícios, séries, repetições e a
                frequência ideal.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-body text-secondary">
                Durante as sessões, seu personal trainer irá te guiar em cada
                exercício, corrigindo a postura, motivando e garantindo que você
                execute o treino de forma segura e eficaz.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-body text-secondary">
                Seu progresso será monitorado de perto, e o plano de treino será
                ajustado regularmente para garantir que você continue a evoluir
