            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              {['Funk', 'Pop', 'Axé', 'Sertanejo', 'Hip Hop', 'Reggaeton'].map((style) => (
                <div key={style} className="card text-center">
                  ...
                  <h3 className="text-heading text-neutral-text-primary">{style}</h3>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="container-main">
          <div className="text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="https://agendamento.panobiancosatelite.com.br/" className="bg-white text-red-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
