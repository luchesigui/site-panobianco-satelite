        ...
        <div className="container-main">
          <div className="text-center">
            ...
            <p className="text-xl text-neutral-text-secondary max-w-3xl mx-auto">
              Estamos sempre prontos para te atender! Tire suas dúvidas, agende sua aula experimental ou saiba mais sobre nossos planos.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-body text-neutral-text-secondary mb-8">
                Preencha o formulário abaixo e retornaremos em até 24 horas úteis. Sua primeira aula experimental é gratuita!
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="assunto" className="block text-body text-neutral-text-primary mb-2">
                    Assunto
                  </label>
                  <input
                    type="text"
                ...
                <div className="space-y-6">
                  ...
                  <div className="card">
                    ...
                    <p className="text-body text-neutral-text-secondary mb-4">
                      Siga-nos para ficar por dentro das novidades e dicas de treino!
                    </p>
              ...
              <div className="card">
                ...
                <div className="bg-neutral-background rounded-lg p-4">
                  <p className="text-subtext text-neutral-text-secondary text-center">
                    <strong>Dica:</strong> Para evitar horários de pico, venha preferencialmente entre 9h-16h ou após 21h!
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container-main">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="card">
              ...
              <p className="text-body text-neutral-text-secondary">
                Você pode agendar através do formulário nesta página, pelo WhatsApp (12) 99219-2268 ou diretamente na recepção da academia.
              </p>
            </div>
            ...
            <div className="card">
              ...
              <p className="text-body text-neutral-text-secondary">
                Apenas roupas confortáveis para exercício, tênis e uma garrafa de água. Temos vestiários completos com chuveiros.
              </p>
            </div>
            ...
            <div className="card">
              ...
              <p className="text-body text-neutral-text-secondary">
                Nossa localização oferece fácil acesso e opções de estacionamento nas proximidades, além de transporte público.
              </p>
            </div>
          </div>
        </div>
